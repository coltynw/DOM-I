...
const middleH1 = document.createElement('h1');

ctaText.prepend(middleH1);
ctaText.prepend(firstH1);

firstH1.textContent = h1Arr[0];
middleH1.textContent = h1Arr[1];
...
headerImg.alt = 'big circle image';
